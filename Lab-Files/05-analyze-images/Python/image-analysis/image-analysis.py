...
def main():
    ...
    try:
        ...
        # Get image
        image_file = r'C:\Users\Mrinal Bhan\Cerebrum\AI-102-AI-Engineer\Lab-Files\Azure-AI-Vision\mslearn-ai-vision\Labfiles\01-analyze-images\Python\image-analysis\images\street.jpg'
        if len(sys.argv) > 1:
